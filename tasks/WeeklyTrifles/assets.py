...
class WeeklyTriflesAssets: 
	...
	# 微信分享 
	I_WT_AB_WECHAT = RuleImage(roi_front=(920,646,50,41), roi_back=(689,620,172,85), threshold=0.8, method="Template matching", file="./tasks/WeeklyTrifles/area_boss/area_boss_wt_ab_wechat.png")
	...
	# 微信 
	I_WT_SE_WECHAT = RuleImage(roi_front=(823,641,45,37), roi_back=(632,601,148,89), threshold=0.8, method="Template matching", file="./tasks/WeeklyTrifles/secret/secret_wt_se_wechat.png")
	# 勾玉 
